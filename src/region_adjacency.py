...
Directions: 'N', 'S', 'E', 'W' (cardinal only - no diagonals)
...
1. Add/update regions in src/region_config.py
...
- Exports cardinal directions only (diagonal neighbors appear in multiple cardinal directions)
"""
