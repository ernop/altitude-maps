...
IMPORTANT: This module loads data from generated/region_adjacency.json which is
generated by compute_adjacency.py. To update adjacency data:
...
_ADJACENCY_FILE = Path(__file__).parent.parent / 'generated' / 'region_adjacency.json'
