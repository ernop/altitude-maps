...
REGIONS: Dict[str, RegionConfig] = {
    ...
    "chicago_downtown": RegionConfig(
        id="chicago_downtown",
        name="Chicago Downtown",
        bounds=(-87.86, 41.75, -87.40, 41.98),
        description="USA - Chicago close downtown region, ~12x12 mile area centered on the Loop",
        region_type=RegionType.AREA,
        country="United States of America",
        clip_boundary=False,
    ),
    "tokyo_bay": RegionConfig(
        id="tokyo_bay",
        name="Tokyo and Tokyo Bay",
        bounds=(138.61, 34.78, 140.39, 36.23),
        description="Japan - Tokyo and Tokyo Bay region, ~100x100 mile area including the city and bay",
        region_type=RegionType.AREA,
        country="Japan",
        clip_boundary=False,
    ),
    "tokyo_bay_only": RegionConfig(
        id="tokyo_bay_only",
        name="Tokyo Bay",
        bounds=(139.45, 35.0, 140.0, 35.6),
        description="Japan - Tokyo Bay only, covering the bay waters and immediate coastal edges (Miura Peninsula to Bōsō Peninsula)",
        region_type=RegionType.AREA,
        country="Japan",
        clip_boundary=False,
    ),
    "misaka_tenshu_range": RegionConfig(
        id="misaka_tenshu_range",
        name="Misaka-Tenshu Range",
        bounds=(138.96, 35.47, 139.04, 35.53),
        description="Japan - Semi-circular mountain range east of Mount Fuji, featuring Mount Kenashi (1,945m) and the crescent-shaped Kantō Range, with Tokyo Bay to the east. ~4x4 mile area.",
        region_type=RegionType.AREA,
        country="Japan",
        clip_boundary=False,
    ),
    "athens_close": RegionConfig(
        id="athens_close",
        name="Athens Close-Up",
        bounds=(23.59, 37.86, 23.87, 38.08),
        description="Greece - Athens close-up region, 15x15 mile area centered on the city",
        region_type=RegionType.AREA,
        country="Greece",
        clip_boundary=False,
    ),
    "long_island": RegionConfig(
        id="long_island",
        name="Long Island",
        bounds=(-73.5, 40.5, -72.0, 41.2),
        description="USA - Long Island, New York, including Nassau and Suffolk counties",
        region_type=RegionType.AREA,
        country="United States of America",
        clip_boundary=False,
    ),
    "lake_titicaca": RegionConfig(
        id="lake_titicaca",
        name="Lake Titicaca",
        bounds=(-70.27, -16.77, -68.33, -14.83),
        description="Peru/Bolivia - Lake Titicaca region, 120x120 mile square centered on the lake",
        region_type=RegionType.AREA,
        clip_boundary=False,
    ),
}
