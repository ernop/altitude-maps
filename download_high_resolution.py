...
from src.regions_config import ALL_REGIONS as REGIONS
...
# REGIONS NOW COMES FROM src.regions_config (imported above)
...
# Show all regions from centralized config
 ...
 print("\n You can also define custom bounds with --bounds\n")
 return 0
...
# USGS instructions only
 ...
 config = REGIONS[region_id]
 print_usgs_3dep_instructions(config.name, config.bounds)
 else:
