 ...
 * - js/activity-log.js         → UI activity log (timestamped events, copy to clipboard)
 * - js/edge-markers.js         → Directional markers (N/E/S/W labels at terrain edges)
 * - js/ui-loading.js           → Loading screen and progress bar management
 * - js/borders-contours.js     → Border lines and elevation contours rendering
 * 
